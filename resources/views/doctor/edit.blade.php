        ...
        <div class="row d-flex justify-content-center ">
            <div class="col-8 shadow-lg rounded-5 mt-3 bg-light">
                ...
                <form id="my-form" action="{{ route('profiles.update', $profile) }}" method="post"
                    ...
                    <button type="submit" class="btn btn-primary w-100 mt-4 py-2 px-4 my-5 border-0 text-white cursor-pointer inline-block position-relative text-decoration-none user-select-none rounded-5 fs-5 fw-semibold text-center select-none blue-btn">Edit Profile</button>
