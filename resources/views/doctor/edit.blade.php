...
<div class="container ">
    <div class="row d-flex justify-content-center ">
        <div class="col-8 shadow rounded-5 mt-3">
            ...
            <div class="mb-5">
                ...
                <input id="surname" class="form-control w-100 d-inline-block" type="text" value="{{ $profile->user->name }}" disabled>
            ...
            <div class="mb-5">
                ...
                <input id="surname" class="form-control w-100 d-inline-block" type="text" value="{{ $profile->user->surname }}" disabled>
                <small class="text-muted w-100 d-inline-block">You can't change this field here</small>
            </div>
            <form id="my-form" action="{{ route('profiles.update', $profile) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-5">
                    ...
                    <input type="number" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror w-100 d-inline-block" placeholder="Add Phone Number" aria-describedby="helpPhone_number" value="{{ old('phone_number', $profile->phone_number) }}">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror w-100 d-inline-block" placeholder="Add address" aria-describedby="helpAddress" value="{{ old('address', $profile->address) }}">
                ...
                <div class=" mb-5 ">
                    ...
                    <div>
                        ...
                        <input type="file" name="doctor_image" id="doctor_image" class="form-control @error('doctor_image') is-invalid @enderror">
                ...
                <div class="mb-5">
                    ...
                    <textarea class="form-control @error('performances') is-invalid @enderror" name="performances" id="performances" aria-describedby="helpPerformances" rows="3"> {{ old('performances', $profile->performances) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check @error('specializations') is-invalid @enderror">
                        <label class="form-check-label">
                            @if ($errors->any())
                            <input name="specializations[]" type="checkbox" value="{{ $specialization->id }}" class="form-check-input" {{ in_array($specialization->id, old('specializations', [])) ? 'checked' : '' }}>
                            @else
                            <input name='specializations[]' type='checkbox' value='{{ $specialization->id }}' class='form-check-input' {{ $profile->specializations->contains($specialization) ? 'checked' : '' }}>
                            @endif
                            {{ $specialization->name }}
                        </label>
                    </div>
