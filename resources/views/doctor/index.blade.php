            ...
            <div class="card shadow p-3">
                ...
                <div class="d-flex">
                    <div class="row gap-1 p-3">
                        <div class="col">
                            {{-- your Reviews --}}
                            <a class="btn btn-primary" href="{{ route('reviews') }}" role="button">Reviews</a>
                        </div>
                        ...
                        <div class="col">
                            {{-- delete button  --}}
                            <a class="btn btn-danger" role="button" data-bs-toggle="modal" data-bs-target="#deleteModal-{{ $profile->id }}">Delete</a>
                        </div>
                    ...
                    {{-- Modal --}}
                    <div class="modal fade" id="deleteModal-{{ $profile->id }}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
