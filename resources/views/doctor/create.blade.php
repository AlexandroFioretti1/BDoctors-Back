...
<div class="container">
    ...
    <form id="my-form" action="{{ route('profiles.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" placeholder="Add address" aria-describedby="helpAddress" value="{{ old('address') }}">
