        ...
        <div class="col-8 shadow rounded-5 mt-5">
            <form id="my-form" action="{{ route('profiles.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="number" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" placeholder="Add Phone Number" aria-describedby="helpPhone_number" value="{{ old('phone_number') }}">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="address" id="address" class="form-control w-100 @error('address') is-invalid @enderror" placeholder="Add address" aria-describedby="helpAddress" value="{{ old('address') }}">
                    <small id="helpAddress" class="text-muted w-100"> <p></p>Insert your office's Address</small>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea class="form-control @error('performances') is-invalid @enderror" name="performances" id="performances" aria-describedby="helpPerformances" rows="3"></textarea>
